...
- **Follow links** — click a link to another markdown file and it renders right in the preview (with back/forward, live reload, search, and heading anchors all working); links to non-markdown files open normally in the browser (e.g., images render, `.txt` shows as raw text)
